...
internal static class KanaToHiraganaTextContainerEx
{
	internal static ConversionResult ConvertKanaToHiragana(this ITextContainer @this, UnrecognisedCharacterPolicy unrecognisedCharacterPolicy, ObjectPool<StringBuilder>? stringBuilderPool)
	{
		if (@this.IsEmpty)
