...
public static class KanaToHiraganaEx
{
	...
	extension(StringBuilder @this)
	{
		...
		public string KanaToHiragana(UnrecognisedCharacterPolicy unrecognisedCharacterPolicy = default, ObjectPool<StringBuilder>? stringBuilderPool = null)
		{
		...
		public bool TryConvertKanaToHiragana(out string value) =>
		...
		/// <param name="unrecognisedCharacterPolicy">Behaviour how unrecognised characters are treated.</param>
		/// <param name="value">Romaji string after conversion.</param>
		public bool TryConvertKanaToHiragana(UnrecognisedCharacterPolicy unrecognisedCharacterPolicy, out string value) =>
		...
		/// <param name="stringBuilderPool">String builder pool that is useful when many strings are converted in a loop.</param>
		/// <param name="value">Romaji string after conversion.</param>
		public bool TryConvertKanaToHiragana(UnrecognisedCharacterPolicy unrecognisedCharacterPolicy, ObjectPool<StringBuilder>? stringBuilderPool, out string value)
		{
			var result = new StringBuilderTextContainer(@this)
				.ConvertKanaToHiragana(unrecognisedCharacterPolicy, stringBuilderPool);
